...
const Main = () => {    
    return (
       <main id="home">
            ...
            <video  src="https://v.etsystatic.com/video/upload/s--q0GjfJpQ--/ac_none,c_crop,du_15,h_720,q_auto:good,w_720,x_282,y_0/5_yzznct.mp4" preload="true" autoPlay loop  className="position-absolute top-0 end-0 mx-5" style={{objectFit: "warp",}} width={"440px"} height={"650px"}>
            </video>
            </section>
